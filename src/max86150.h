...
//  #include "Arduino.h"
// #else
//  #include "WProgram.h" // older library
// #endif

#include <Wire.h>

#define MAX86150_ADDRESS 0x5E // 7-bit I2C Address of MAX86150
...
public:
	...
	void setup(byte powerLevel = 0x1F, byte sampleAverage = 1, byte ledMode = 3, int sampleRate = 400, int pulseWidth = 411, int adcRange = 4096);
